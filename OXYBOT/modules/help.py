...
HELP_STRING = f"𝗚𝗢𝗝𝗢ꭙ 𝗦𝗽𝗮𝗺🫧 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **𝐂𝐋𝐈𝐂𝐊 𝐎𝐍 𝐁𝐔𝐓𝐓𝐎𝐍 𝐅𝐎𝐑 𝐇𝐄𝐋𝐏**\n» **𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥: 𝗚𝗢𝗝𝗢ꭙ 𝗦𝗽𝗮𝗺🫧**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("★𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥★", "https://t.me/Gojosatoru003"),
      Button.url("★𝗦𝗨𝗣𝗣𝗢𝗥𝗧★", "https://t.me/TeamRolexx")
    ],
  [   
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://telegra.ph/file/ef612f611037a70d5790e.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
